...
String getRFID()                                                      // Hàm để đọc mã RFID từ thẻ
{
...
void addParkedRFID(String rfid)                                       // Hàm để thêm thông tin thẻ đã đỗ vào mảng
{
...
void removeParkedRFID(String rfid)                                      // Hàm để xóa thông tin thẻ đã rời khỏi mảng
{
...
void buzzBuzzer(unsigned int duration)                                  // Hàm để kêu còi với thời gian cho trước
{
...
void startBuzzer()                                                      // Hàm để bắt đầu phát tín hiệu còi
{
...
void stopBuzzer()                                                       // Hàm để dừng còi
{
  digitalWrite(BUZZER_PIN, LOW);                                        // Dừng phát tín hiệu còi
  buzzerStartTime = 0;                                                  // Đặt thời gian bắt đầu kêu còi về 0
}

bool isBuzzerOn()                                                       // Hàm kiểm tra xem còi có đang kêu không
{
  return buzzerStartTime > 0;                                           // Kiểm tra xem còi có đang kêu không dựa trên thời gian bắt đầu
}
